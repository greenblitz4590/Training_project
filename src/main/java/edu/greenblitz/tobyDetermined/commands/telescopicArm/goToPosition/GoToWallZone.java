...
public class GoToWallZone extends SimpleGoToPosition{
	...
	protected GoToWallZone() {
		super(RobotMap.TelescopicArm.Extender.BACKWARDS_LIMIT, (RobotMap.TelescopicArm.Elbow.END_WALL_ZONE_ANGLE+RobotMap.TelescopicArm.Elbow.STARTING_WALL_ZONE_ANGLE) /2, false);
